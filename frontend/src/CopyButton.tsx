...
/** Copy, with the legacy fallback that matters here: the sandboxed WKWebView may not delegate
 *  `clipboard-write`, and a copy button that silently fails is a dead button (AGENTS.md §9).
 *  Exported so every copy affordance shares the one resilient path. */
